...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item The incidence rate among smokers was: \Sexpr{Ir_45smoker}
    \item The incidence rate among nonsmokers was: \Sexpr{Ir_45Nonsmoker}
  ...
  \begin{enumerate}
    \item The incidence rate among smokers was: \Sexpr{Ir_75smoker}
    \item The incidence rate among nonsmokers was: \Sexpr{Ir_75Nonsmoker}
