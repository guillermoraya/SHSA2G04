...
@
  \begin{enumerate}
    \item The incidence rate among smokers was \Sexpr{Ir_45smoker} 1000 person per year.
    \item The incidence rate among nonsmokers was \Sexpr{Ir_45Nonsmoker} 1000 person per year.
...
<<IncidenceRates3>>=
# a)
Ir_75smoker <- Ir_smokers[5]/10 # 100 person per year
# b)
Ir_75Nonsmoker <- Ir_Nonsmokers[5]/10 # 100 person per year
# c) 
...
@
  \begin{enumerate}
    \item The incidence rate among smokers was \Sexpr{Ir_75smoker} 100 person per year.
    \item The incidence rate among nonsmokers was \Sexpr{Ir_75Nonsmoker} 100 person per year.
